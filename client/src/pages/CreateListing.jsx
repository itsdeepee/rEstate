        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className=' flex flex-col gap-4 flex-1'>
                ...
                <div className='flex gap-6 flex-wrap'>
                    ...
                    <div className='flex gap-2'>
                        <input onChange={handleChange} value={formData.offer} className='w-5' type="checkbox" id='offer'  />
                        <span>Offer</span>
                    </div>
                </div>
                <div className='flex flex-wrap  gap-6'>
                    ...
                    <div className='flex items-center gap-2'>
                        <input onChange={handleChange} value={formData.bedrooms} className='p-3 border boder-gray-300 rounded-lg' type="number" id="bedrooms" min='1' max='10' required/>
                        <p>Bedrooms</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <input onChange={handleChange} value={formData.bathrooms}  className='p-3 border boder-gray-300 rounded-lg' type="number" id="bathrooms" min='1' max='10' required/>
                        <p>Bathrooms</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <input onChange={handleChange} value={formData.regularPrice} className='p-3 border boder-gray-300 rounded-lg' type="number" id="regularPrice" min='50' max='1000000' required/>
                        <div className='flex flex-col items-center '>
                            <p>Regular price</p>
                            <span className='text-xs'>(LEI / month)</span>
                        </div>
                        
                    </div>
                    {formData.offer && ( <div className='flex items-center gap-2'>
                        <input onChange={handleChange} value={formData.discountPrice} className='p-3 border boder-gray-300 rounded-lg' type="number" id="discountPrice" min='0' max='1000000' required/>
                        <div className='flex flex-col items-center '>
                            <p>Discount price</p>
                            <span className='text-xs'>(LEI / month)</span>
                        </div>
