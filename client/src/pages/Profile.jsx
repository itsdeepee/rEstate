...
import { updateUserSuccess,updateUserStart,updateUserFailure, deleteUserFailure, deleteUserStart, deleteUserSuccess, signOutUserStart, signOutUserFailure, signOutUserSuccess } from '../redux/user/userSlice.js';
 ...
 */
  ...
  const handleListingDelete=async(listingId)=>{
    try{
      ...
      setUserListings((prev)=>prev.filer((listing)=>listing._id!==listingId))
    }catch(error){
      //
    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <img 
            ...
            src={formData.photo || currentUser.photo} alt="profilePhoto" />
